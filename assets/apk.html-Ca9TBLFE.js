import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as s,b as e}from"./app-DOGW-9XX.js";const i={},l=e(`<h1 id="apk" tabindex="-1"><a class="header-anchor" href="#apk"><span>apk</span></a></h1><p>Alpine Linux 下的包管理工具</p><h2 id="使用实例" tabindex="-1"><a class="header-anchor" href="#使用实例"><span>使用实例</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>apk <span class="token function">install</span> xxx
