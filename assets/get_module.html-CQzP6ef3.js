import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,e}from"./app-D_HUMAmc.js";const i={},l=e(`<h1 id="get-module" tabindex="-1"><a class="header-anchor" href="#get-module"><span>get_module</span></a></h1><p>获取Linux内核模块的详细信息</p><h2 id="补充说明" tabindex="-1"><a class="header-anchor" href="#补充说明"><span>补充说明</span></a></h2><p><strong>get_module命令</strong> 用于获取Linux内核模块的详细信息。</p><h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>get_module 模块名
