import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as n,b as s}from"./app-D3p8wuGf.js";const i={},l=s(`<h1 id="chage" tabindex="-1"><a class="header-anchor" href="#chage"><span>chage</span></a></h1><p>修改帐号和密码的有效期限</p><h2 id="补充说明" tabindex="-1"><a class="header-anchor" href="#补充说明"><span>补充说明</span></a></h2><p><strong>chage命令</strong> 是用来修改帐号和密码的有效期限。</p><h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>chage <span class="token punctuation">[</span>选项<span class="token punctuation">]</span> 用户名
