import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as n,e as s}from"./app-D_HUMAmc.js";const t={},i=s(`<h1 id="dhcpd" tabindex="-1"><a class="header-anchor" href="#dhcpd"><span>dhcpd</span></a></h1><p>运行DHCP服务器</p><h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>dhcpd <span class="token punctuation">[</span>选项<span class="token punctuation">]</span> <span class="token punctuation">[</span>网络接口<span class="token punctuation">]</span>
