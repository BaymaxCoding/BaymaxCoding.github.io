import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as s,e}from"./app-D_HUMAmc.js";const i={},l=e(`<h1 id="rename" tabindex="-1"><a class="header-anchor" href="#rename"><span>rename</span></a></h1><p>用字符串替换的方式批量改变文件名</p><h2 id="补充说明" tabindex="-1"><a class="header-anchor" href="#补充说明"><span>补充说明</span></a></h2><p>rename命令存在两个版本用法上有所区别</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>C语言版本, 支持通配符
